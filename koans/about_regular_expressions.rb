...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # Answer: maximum number of chars are returned
  ...
  # Answer: character class: only single chars, alteration: strings
  ...
  def test_sub_is_like_find_and_replace
    ...
    # same as: "one two-three".sub(/(t\w*)/,$1[0,1])
  end
